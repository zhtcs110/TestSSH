...
<tr>
<td align="right" > <a href="${pageContext.request.contextPath}/employee_add.action">
<img src="${pageContext.request.contextPath }/images/add.jpg" height="30" width="30"></a></td>
</tr>
</table>
<br/>
...
<td align="center"><a href="${pageContext.request.contextPath }/employee_edit.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath }/images/edit.jpg" height="15" width="15"></a></td>
<td align="center"><a href="${pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath }/images/delete.png" height="15" width="15"></a></td>
